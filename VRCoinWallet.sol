...
contract VRCoinWallet is ERC20Burnable
{
    // Public data
    string public constant name = "VRCoin";
    string public constant symbol = "VRC";
    uint256 public constant decimals = 4;
    address public owner;  

    // Internal data
    uint256 private constant initialSupply = 50000000; // 50,000,000
    uint256 private currentSupply;
    mapping(address => uint256) private balances;
    mapping(address => mapping (address => uint256)) private allowed;

    function VRCoinWallet()
    {
